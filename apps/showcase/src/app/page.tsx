      ...
      <section className="border-b border-black/10 bg-[radial-gradient(circle_at_top_right,_rgba(140,106,79,0.12),_transparent_32%),linear-gradient(135deg,_#f6f0e8,_#f3ece3_58%,_#ebe3d5)]">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-18 md:py-24">
          <div className="space-y-4">
            ...
            <h1 className="max-w-5xl text-5xl font-semibold leading-none md:text-7xl">Six independent front faces over one shared backend.</h1>
            <p className="max-w-3xl text-lg text-black/70">
              The point of comparison is the sharpness of difference. Each variant keeps its own layout, pacing, typography,
              and tone so the final choice remains real instead of collapsing into a mixed compromise.
            </p>
          </div>
        </div>
      </section>
